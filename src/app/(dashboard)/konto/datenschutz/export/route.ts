...
export async function GET() {
  ...
  const [profile, portfolios, categories, positions, settings, legalAcceptances] = await Promise.all([
  ...
  const queries = [profile, portfolios, categories, positions, settings, legalAcceptances];
