...
export async function GET() {
  ...
  const [profile, portfolios, categories, positions, cashBalances, settings, legalAcceptances, importHistory] = await Promise.all([
  ...
  const queries = [profile, portfolios, categories, positions, cashBalances, settings, legalAcceptances, importHistory];
