...
export const CALCULATION_REASON_LABELS: Record<CalculationReason, string> = {
  ...
  current_price_demo: "Demo-Kurs wird nicht als realer Kurs verwendet",
  current_price_stale: "aktueller Kurs ist als veraltet markiert",
  ...
  fx_to_base_demo: "Demo-Wechselkurs wird nicht als realer Wechselkurs verwendet",
  fx_to_base_stale: "Wechselkurs zur Basiswährung ist als veraltet markiert",
  ...
  risk_budget_missing: "konfiguriertes Risikobudget fehlt",
  risk_budget_invalid: "konfiguriertes Risikobudget muss größer als null sein",
  ...
  cash_fx_demo: "Demo-Wechselkurs wird nicht für den Cashbestand verwendet",
  cash_fx_stale: "Wechselkurs für den Cashbestand ist als veraltet markiert",
